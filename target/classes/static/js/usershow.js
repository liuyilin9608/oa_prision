...
$('.usershow').popover({
		...
		template: '<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="thisdiv" style="border: 0px solid red;min-width: 160px;height: 120px;">'
			...
			+'<tr><td style="padding:4px">Role:</td><td class="thisrole" style="padding:4px">部门领导</td></tr>'
...
/*外部员工资料版*/
	$('.othershow').popover({
		...
		template: '<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="thisdiv" style="border: 0px solid red;min-width: 160px;height: 120px;">'
			+'<table class="table thistable">'
			+'<tr><td style="padding:4px">Sex:</td><td class="thisrole" style="padding:4px">部门领导</td></tr>'
