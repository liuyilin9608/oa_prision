	...
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			...
			<div class="box-header">
				...
				<tr class="top ss">
					<td colspan="14" class="wi "><div class="bottom" ><label class="control-label font">公文申请明细</label></div></td>
				</tr>
				
				<tr class="rile ">
					<td class="wi" style="width:100px;"><label class="control-label">开始日期</label></td>
					<td  style="width:140px;"><div class="bottom">${map.startime}</div></td>
					<td class="wi" style="width:100px;"><label class="control-label">结束日期</label></td>
					<td  style="width:140px;"><div class="bottom">${map.endtime}</div></td>
					<td class="css" style="width:30px;"></td>
					<td class="wi"><label class="control-label">公文标题</label></td>
					<td colspan="4" ><div class="bottom">${(eve.title)!''}</div></td>
				</tr>
				
				<tr class="rile">
					<td class="wi" style="width:100px;"><label class="control-label">公文主题</label></td>
					<td  style="width:140px;"><div class="bottom">${(eve.theme)!''}</div></td>
					<td class="wi" style="width:100px;"><label class="control-label">公文备注</label></td>
					<td  style="width:140px;"><div class="bottom">${(eve.printRemark)!''}</div></td>
					<td class="css" style="width:30px;"></td>
					<td class="wi"><label class="control-label">公文资料</label></td>
					<td colspan="4" ><div class="bottom">
					        <#if map.file!='file'>		
							<a href="file?fileid=${(map.file.attachmentId)!''}" class="label xiugai">
							<span class="glyphicon glyphicon-search"></span> 公文资料下载</a>
							</#if>
						</div>
					</td>
