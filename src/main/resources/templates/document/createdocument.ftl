...
<div class="row" style="padding-top: 10px;">
	<div class="col-md-2">
		<h1 style="font-size: 24px; margin: 0;" class="">新建公文</h1>
	</div>
	<div class="col-md-10 text-right">
		<a href="##"><span class="glyphicon glyphicon-home"></span> 首页</a> > <a
			disabled="disabled">新建公文</a>
	</div>
</div>
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			<form action="uploadDocument" enctype="multipart/form-data" method="post" onsubmit="return check();" >
			<div class="box-header">
				<table class="bo table ">
			
				<tr >
					<td colspan="14" class="title"><h2>新建公文申请</h2></td>
				...
				<tr >
					<td class="title"><label class="control-label">公文标题</label></td>
					<td  colspan="6"><input type="text" class="form-control inpu" name ="title" /></td>
					<td class="title"><label class="control-label">公文主题</label></td>
					<td  colspan="6"><input type="text" class="form-control inpu" name ="theme"  /></td>	
				</tr>
				<tr >
				...
				<tr >
					...
					<tr >
					<td class="title"><label class="control-label">印刷备注</label></td>
					<td  colspan="6"><input type="text" placeholder="纸质文件份数，版式，分发部门......" class="form-control inpu" name ="printRemark"  /></td>
				...
				<tr >
					<td class="title" ><label class="control-label">公文附件</label></td>
					<td  colspan="6">
						<div class="btn btn-default"style="position: relative; overflow: hidden;width: 100%;
    							margin-top: -6px;">
							<i class="glyphicon glyphicon-open"></i> 上传公文资料
				...
				<tr >
					...
					<input   type="text" value="创建公文" name="val" hidden="hidden"/>
