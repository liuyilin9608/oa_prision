package cn.oa.lzh.services.task;
...
import cn.oa.lzh.model.dao.taskdao.TaskloggerDao;
...
import cn.oa.lzh.model.entity.task.Tasklist;
...
public class TaskService {
	...
	public Page<Tasklist> index3(Long userid,String title,int page,int size){
		...
		// 类型
		SystemTypeList type = tydao.findByTypeModelAndTypeName("task_list", title);
		// 状态
		SystemStatusList status = sdao.findByStatusModelAndStatusName("task_list", title);
		// 找用户
