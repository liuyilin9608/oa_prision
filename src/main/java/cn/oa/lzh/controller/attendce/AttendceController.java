...
public class AttendceController {
	...
	public String test4(Model model, HttpSession session, HttpServletRequest request) {
		...
		SystemStatusList statusList=  statusDao.findByStatusModelAndStatusName("attends", statusname);
	...
	private void typestatus(HttpServletRequest request) {
		List<SystemTypeList> type = (List<SystemTypeList>) typeDao.findByTypeModel("attends");
		List<SystemStatusList> status = (List<SystemStatusList>) statusDao.findByStatusModel("attends");
